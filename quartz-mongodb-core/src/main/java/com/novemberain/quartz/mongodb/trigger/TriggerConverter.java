...
public class TriggerConverter {
  ...
  /**
   * Converts trigger into document. Depending on the config, job data map can be stored as a {@code
   * base64} encoded (default) or plain object.
   */
  ...
  private void loadCommonProperties(
      TriggerKey triggerKey, Document triggerDoc, OperableTrigger trigger) {
