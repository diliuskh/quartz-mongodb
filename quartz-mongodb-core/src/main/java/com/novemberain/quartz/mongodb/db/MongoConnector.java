...
public interface MongoConnector extends Closeable {
  ...
  /**
   * Quartz-mongodb will call this method to get the instance of {@link MongoCollection} for
   * internal uses. The collection is expected to be fully configured with correct {@link
   * WriteConcern}.
   *
  ...
  /**
   * Quartz-mongodb will call this method when shutting down. Implementation can close {@link
   * MongoClient} here.
   */
  @Override
  void close();
