...
public abstract class TriggerPropertiesConverter {
  ...
  private static final List<TriggerPropertiesConverter> propertiesConverters =
      Arrays.asList(
  ...
  public abstract Document injectExtraPropertiesForInsert(
      OperableTrigger trigger, Document original);

  public abstract void setExtraPropertiesAfterInstantiation(
      OperableTrigger trigger, Document stored);
}
