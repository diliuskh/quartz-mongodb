...
public class MongoConnectorBuilder {
  ...
  private static <T> T checkNotNull(final T reference, final String message)
  ...
  private static void checkIsNull(final Object reference, final String message)
      throws SchedulerConfigException {
    if (reference != null) {
      throw new SchedulerConfigException(message);
    }
  ...
  private void checkServersCredsOptionsAreNull(final String suffix)
      throws SchedulerConfigException {
  ...
  public MongoConnectorBuilder withSSL(
      final Boolean enableSSL, final Boolean sslInvalidHostNameAllowed) {
